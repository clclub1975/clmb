<div style="background-color: #fff3cd; border: 1px solid #ffeeba; padding: 15px; border-radius: 5px; margin-bottom: 20px; font-family: sans-serif;">
  ...
  <ul style="margin-bottom: 0; color: #856404; font-size: 14px;">
    <li>현재는 진척 상황을 공유하는 단계이며, 향후 <strong>구글 폼</strong>이 준비되면 '교정'란을 통해 본격적인 피드백 수렴이 진행될 예정입니다.</li>
...
<table style="text-align: center; width: 100%; border-collapse: collapse; table-layout: fixed;">
 ...
 <tr>
  ...
  <td><span style="color: #888; font-size: 12px;">준비중</span></td>
